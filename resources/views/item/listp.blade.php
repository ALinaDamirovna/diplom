                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:right;">
                                            <div style="display: flex;">
                                                ...
                                                <a href="{{ route($viewInfo['mainRoute'] . '.edit', $el->code) }}" class="btn  btn-outline-success btn-sm">Редактировать</a>
                                                {{--
                                                    {{--                                                @can('delete-' . $viewInfo['mainRoute'])--}}
                                                    <form action="{{ route($viewInfo['mainRoute'] . '.destroy', $el->code) }}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
